...
class PurchaseReportController extends Controller
{
    ...
    {
        $purchases = Purchase::whereDate('created_at', $request->frame ? Carbon::today() : date("Y-m-d", strtotime('-1 days')));
        return $total ? $purchases->get() : $purchases->sum($value);
    }
