...
class PurchaseOrderController extends Controller
{
    ...
    {
        //Forget Old customer session & prepare new as per customer
    ...
    public function paid(Purchase $purchase)
    {
        ...
        return back()->with('success', __('Purchase got paid'));
    }
    ...
    public function stockUp(Purchase $purchase)
    {
        ...
        event(
            new LogActivity(
                $purchase->reference,
                ' ' . __('Purchased stock updated'),
                __('Purchase')
            )
        );
        return back()
            ->with('success', __('Stock quantity updated'));
    }
