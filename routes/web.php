...
Route::get('/locale/{locale}', 'Controller@lang')->name('lang');
...
Route::group(
    ...
    function () {
        ...
        Route::get('/language/sync', 'LanguageController@sync')->name('language.sync');
        Route::get('/language/sync/{language}', 'LanguageController@getStrings')->name('language.strings.get');
        Route::post('/language/sync/{language}/update', 'LanguageController@updateStrings')->name('language.strings.update');

        //resource
        Route::resource('/pos', 'PosController')->only('index');
        Route::resource('/sale', 'SaleController')->except('create','edit','update');
        Route::resource('/refund', 'RefundController')->except('create','edit','update');
        Route::resource('/purchase', 'PurchaseController')->except('edit','update');
        Route::resource('/user', 'UserController')->except('show','store');
        Route::resource('/chapter', 'ChapterController')->except('edit','update','destroy');
        Route::resource('/report', 'ReportController')->except('create','edit','update');
