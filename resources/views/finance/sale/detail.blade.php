...
@section('title')
    {{ __('Annually sale chart summary') }}
@endsection
@push('breadcrumbs')
    @include('./partials.breadcrumbs',['group'=>__('Finance'),'links'=> [
    ['url' =>'','name' => __('Sale chart')],
    ]])
@endpush
@section('content')
    <div class="col-md-12">
        <div class="row row-card-no-pd bg-default mb-1">
                    ...
                    <div class="card-body ">
                        <div class="row">
                            <div class="col col-stats">
                                <div class="numbers">
                                    <p class="card-category">{{ __('Sale chart') }}</p>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row">
                            <div class="col col-stats" title="{{ __('Low price index') }}">
                                <div class="numbers">
                                    <p class="card-category">{{ __('Low price index') }}</p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row">
                            <div class="col col-stats">
                                <div class="numbers">
                                    <p class="card-category">{{ __('Net profit') }}</p>
                ...
                <div class="card card-stats card-round">
                    <div class="card-body ">
                        <div class="row">
                            <div class="col col-stats">
                                <div class="numbers">
                                    <p class="card-category">{{ __('Sales') }}</p>
        ...
        <div class="card bg-default">
            <div class="card-header">
                <div class="btn-group float-right">
                    <a href="{{ route('sale.detail') }}?type=bar" class="btn btn-xs text-warning"><i
                            class="fa fa-chart-bar" aria-hidden="true"></i> {{ __('Bar view') }}</a>
                    <a href="{{ route('sale.detail') }}?type=line" class="btn btn-xs text-warning"><i
                            class="fa fa-chart-line" aria-hidden="true"></i> {{ __('Line view') }}</a>
                </div>
                <h4 class="card-title text-warning">
                    {{ __('Sale chart for year') }} {{ date('Y') }}
                </h4>
            </div>
            <div class="card-body">
