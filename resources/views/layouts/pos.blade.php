                                ...
                                <li>
                                    <div class="user-box">
                                        ...
                                        <div class="u-text">
                                            ...
                                            <button class="btn btn-link btn-xs swicher" data-toggle="tooltip"
                                                title="Toggle between POS And Register/Chapter board">{{__('Toggle')}}</button>
                                        </div>
                                    </div>
                                </li>
                                <li class="nav-item">
                                    <div class="dropdown-divider"></div>
                                    <a class="dropdown-item" href="{{ route('home') }}">{{__('Control Panel')}}</a>
                ...
                <div id="app" class="pt-2 bg-default">
                    ...
                    <div class="card m-4 mt-2 p-2" id="chapterBoard">
                        <div class="card-body">
                            ...
                            <div class="p-2"> <a href="{{ route('chapter.show', $openedChapter) }}" target="_blank">{{__('Click here to  view full details (only for authorized persons')}}</a> .
                                <p> {{__('Use same toggle button to move/switch back as well,')}}  <a
                                        href="{{ route('pos.index') }}" class="swicher">{{__('Or click here to force back')}}</a> .</p>
                            </div>
