                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="supplier-info-tab" data-toggle="tab"
                                    href="#supplier-info" role="tab" aria-controls="supplier-info"
                                    aria-selected="true">{{ __('Information') }}</a>
                                <a class="nav-item nav-link" id="supplier-orders-tab" data-toggle="tab"
                                    href="#supplier-orders" role="tab" aria-controls="supplier-orders"
                                    aria-selected="false">{{ __('Purchases') }}</a>
                                <a class="nav-item nav-link" id="supplier-products-tab" data-toggle="tab"
                                    href="#supplier-products" role="tab" aria-controls="supplier-products"
                                    aria-selected="false">{{ __('Products') }}</a>
                            </div>
                        </nav>
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="supplier-info" role="tabpanel"
                                aria-labelledby="supplier-info-tab">
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $supplier->email }}
                                            | <a href="{{ route('dashboard') }}/?quick-mail={{ $supplier->email }}"
                            ...
                            <div class="tab-pane fade" id="supplier-orders" role="tabpanel"
                                aria-labelledby="supplier-orders-tab">
                                @include('./partials.purchases.orders',['orders'=>$supplier->purchases])
                            </div>
                            <div class="tab-pane fade" id="supplier-products" role="tabpanel"
                                aria-labelledby="supplier-products-tab">
