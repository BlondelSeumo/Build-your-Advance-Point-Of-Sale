...
@section('title')
    {{ __('Tax method detail') }}
@endsection

@push('breadcrumbs')
    @include('./partials.breadcrumbs',['links'=> [
    ['url' =>route('tax.index'),'name' => __('Manage')],
    ['url' =>'','name' => __('Tax method detail')],
    ]])
@endpush
@section('content')
    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <nav>
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <a class="nav-item nav-link" id="nav-products-tab" data-toggle="tab" href="#nav-products"
                                    role="tab" aria-controls="nav-products"
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-info" role="tabpanel"
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        <th scope="row" class="th-width-20"> {{ __('Title') }}</th>
                                        <td>{{ $tax->name }}</td>
                                    </tr>
                                    <tr>
