...
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                <a href="{{ route('group.create') }}"
                    class="btn btn-sm btn-info float-right mb-3">{{ __('New group') }}</a>
                        ...
                        <tbody>
                            @foreach ($groups as $key => $group)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a class="btn btn-sm p-0" title="{{ __('Edit group info') }}"
                                                href="{{ route('group.edit', $group->id) }}">
                                                <i class="fa fa-edit fa-fw" aria-hidden="true"></i>
                                            </a>
                                            <a class="btn btn-sm text-success p-0"
    ...
    <!-- Modal -->
    <div class="modal fade" id="groupDeleteModal" tabindex="-1" role="dialog" aria-labelledby="groupDeleteModal"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content text-danger">
                <div class="modal-header">
                    <h4 class="modal-title">{{ __('Group delete warning') }}</h4>
