...
return [
    ...
    */
    ...
    'ends_with' => __('The :attribute must end with one of the following: :values'),
    ...
    */
    ...
    'size'                  => __('size'),
    'barcode_symbology'     => __('barcode symbology'),
    'cost'                  => __('cost'),
    'tax'                   => __('tax'),
    'supplier'              => __('supplier'),
    'unit'                  => __('unit'),
    'alert_quantity'        => __('alert quantity'),
    'discountable'          => __('discountable'),
    'type'                  => __('type'),
    ...
    'sale_prefix' => __('sale prefix'),
    'refund_prefix' => __('refund prefix'),
    'purchase_prefix' => __('purchase prefix'),
    'mail_host' => __('mail host'),
    'mail_port' => __('mail port'),
    'mail_user' => __('mail user'),
    'mail_password' => __('mail password'),
    'mail_encryption' => __('mail encryption'),
    'default_email'=> __('default email'),
    'state' => __('state'),
    'search' => __('search'),
    ],
